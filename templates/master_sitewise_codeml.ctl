    ...
    CodonFreq = CODONFREQMODEL  * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
       aaDist = 0  * 0:equal, +:geometric; -:linear, 1-6:G1974,Miyata,c,p,v,a

        model = 0  * 0:one, 1:b, 2:2 or more dN/dS ratios for branches
      NSsites = WHICHMODEL  * 0:one w;1:neutral;2:selection; 3:discrete;4:freqs;
    ...
    fix_omega = FIXOMEGA  * 1: omega or omega_1 fixed, 0: estimate 
        omega = INITIALOMEGA  * initial or fixed omega, for codons
