...
foreach my $file (@ARGV) {
    ...
    my $command = "$masterPipelineDir/scripts/pw_makeTreeAndRunPAML.pl $moreOptions --omega $initialOrFixedOmega --codon $codonFreqModel --clean $cleanData $file >> $logFile 2>&1"; 
